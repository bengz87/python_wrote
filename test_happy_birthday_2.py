...
FILE_FUNCTION_MAP = {"happy_birthday.py":[""]}
...
def test_for_happy_birthday_function_output():
    ...
    if import_error is not None:
        custom_error_message_no_happy_birthday_func = create_custom_error_json(
            feedback=f"A happy_birthday() function should be defined",
            points_per_error=30,
            max_points_deducted=30,
            number_of_errors=1,
        )
        assert import_error is None, custom_error_message_no_happy_birthday_func
